...
<form method="post" action="res.jsp" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 你好<%=nc %></strong> <a href="/webwork/login.jsp?id=clear" style="float:right; ">退出登录</a></div>
    ...
    <table class="table table-hover text-center">
      ...
      if(nowpage==1){
    	  if(totalpage==1){
        	  ...
        	  out.print("<td colspan=11><div class=pagelist> <a href=show.jsp?page="+(nowpage+1)+">下一页</a> <a href=show.jsp?page="+totalpage+">尾页</a> </div></td>");
    	  }
      }
      else if(nowpage==totalpage){
    	  out.print("<td colspan=11><div class=pagelist> <a href=show.jsp?>首页</a> <a href=show.jsp?page="+(nowpage-1)+">上一页</a> </div></td>");
      }else{
    	  out.print("<td colspan=11><div class=pagelist> <a href=show.jsp?>首页</a> <a href=show.jsp?page="+(nowpage-1)+">上一页</a><a href=show.jsp?page="+(nowpage+1)+">下一页</a> <a href=show.jsp?page="+totalpage+">尾页</a> </div></td>");
