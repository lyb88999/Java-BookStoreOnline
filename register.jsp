            ...
            <div class="panel loginbox">
                ...
                <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input input-big" name="nc" placeholder="请输入昵称" data-validate="required:请填写昵称" />
                            <span class="icon icon-user margin-small"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input input-big" name="name" placeholder="请输入账号" data-validate="required:请填写账号" />
                            <span class="icon icon-user margin-small"></span>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="media media-y margin-big-bottom"><a href="login.jsp">立即登陆</a></div>
            </div>
            </form>          
        </div>
    </div>
