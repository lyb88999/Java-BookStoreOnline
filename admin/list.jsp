    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
        ...
        for(int i=0;i<5;i++)
        {
        	...
        	out.print("<td><div class=button-group> <a class=button border-main href=updatev2.jsp?id="+rs.getInt(1)+"><span class=icon-edit></span> 修改</a> <a class=button border-red href=javascript:void(0) onclick='return del("+rs.getInt(1)+")'><span class=icon-trash-o></span> 删除</a> </div></td></tr>");
      ...
      if(nowpage==1){
    	  if(totalpage==1){
        	  ...
        	  out.print("<td colspan=11><div class=pagelist> <a href=list.jsp?page="+(nowpage+1)+">下一页</a> <a href=list.jsp?page="+totalpage+">尾页</a> </div></td>");
    	  }
      }
      else if(nowpage==totalpage){
    	  out.print("<td colspan=11><div class=pagelist> <a href=list.jsp?>首页</a> <a href=list.jsp?page="+(nowpage-1)+">上一页</a> </div></td>");
      }else{
    	  out.print("<td colspan=11><div class=pagelist> <a href=list.jsp?>首页</a> <a href=list.jsp?page="+(nowpage-1)+">上一页</a><a href=list.jsp?page="+(nowpage+1)+">下一页</a> <a href=list.jsp?page="+totalpage+">尾页</a> </div></td>");
